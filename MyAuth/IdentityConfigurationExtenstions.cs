...
namespace MyAuth
{
    public static class IdentityConfigurationExtenstions
    {
        ...
        public static IEnumerable<ApiResource> GetApiResources(this IConfiguration configuration)
        {
            return new[]
            {
                new ApiResource("thamco_account_api", "ThAmCo Account Management"),

                new ApiResource("staff_product_new, Staff Product Service")
                {
